...
- [Godot Engine 4.x](https://godotengine.org/) como motor de desenvolvimento
- GDScript para lógica e gameplay
- [Blender](https://www.blender.org/) para modelagem 3D
- [Photoshop](https://www.adobe.com/br/products/photoshop.html) e [Krita](https://krita.org/) para manipulação de imagens
